...
Now, just remove .DS_Store from your master repository. If you want a script to remove .DS_Store files form your folders, you can use [this script](http://www.github.com/angelitomg/remove-dsstore). ;)
